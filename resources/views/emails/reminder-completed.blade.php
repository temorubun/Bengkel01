...
<head>
    ...
    <title>Pengingat Selesai - MyMoney</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p class="description">
                Pengingat berikut telah berhasil diselesaikan:
            </p>
            ...
            <div class="reminder-details">
                ...
                <p><strong>Pengingat Berikutnya:</strong> {{ $reminder->getNextReminderDate()->format('d F Y') }}</p>
                @endif
            </div>
            
            <div class="button-container">
                <a href="{{ route('reminders.index') }}" class="button">Lihat Daftar Pengingat</a>
            </div>
